    ...
    <nav className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container mx-auto py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <Link to="/" className="text-gray-700 hover:text-restaurant-primary transition duration-300">
            Home
          </Link>
          <Link to="/restaurants" className="text-gray-700 hover:text-restaurant-primary transition duration-300">
            Restaurants
          </Link>
